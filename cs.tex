...
To include graphics that should not be considerd figures, and should not have a caption or label, please use the \textbf{\textbackslash{}includegraphics\{\}} command.
...
\begin{programCode}[language=PhP]
