...
%custom references heading which we will add a dashed rule too
\vspace*{2em}\fontfamily{phv}\selectfont\Large References  \normalsize
...
\vspace*{1.5em}\fontfamily{phv}\selectfont\Large About the authors  \normalsize
